...
config.read(os.environ['XYMONCLIENTHOME']+'/etc/freebox_v6.ini')
...
## POP-S has only 1 temperature probe, 1 CPU temperature probe and 1 fan
		if not system_status['model_info']['name'] == 'fbxgw8-r1':
			config['monitoring_details']['temp_switch_max']
			...
			temp_cpu_max = config['monitoring_details']['temp_cpu_max']
			if sensor['id'] == 'temp_cpu0':
...
## POP-S has only 1 temperature probe, 1 CPU temperature probe and 1 fan
	...
	if system_status['model_info']['name'] == 'fbxgw8-r1':
		temp_cpu_color = test_max_threshold(temp_cpu,temp_cpu_max)
		_msg_line = "&%sUptime: %s\n&%sDownload_bandwidth: %s\n&%sUpload_bandwidth: %s\nDownload_rate: %s\nUpload_rate: %s\n&%sFan0_RPM: %s\n&%sT1_temperature: %s\n&%sCPU_temperature: %s\n&%sDisk status: %s\n&%sDisk name: %s\n&%sBox authenticated: %s\n\n" % (uptime_color, uptime, bandwidth_down_color, bandwidth_down, bandwidth_up_color, bandwidth_up, download, upload, fan0_status_color, fan0_rpm, temp_t1_color, temp_t1, temp_cpu_color, temp_cpu, disk_status_color, disk_status, disk_name_color, disk_name, box_authenticated_color, box_authenticated)
## POP-S has only 1 temperature probe, 1 CPU temperature probe and 1 fan
	if not system_status['model_info']['name'] == 'fbxgw8-r1':
			...
			_msg_line = "&%sUptime: %s\n&%sDownload_bandwidth: %s\n&%sUpload_bandwidth: %s\nDownload_rate: %s\nUpload_rate: %s\n&%sFan0_RPM: %s\n&%sFan1_RPM: %s\n&%sT1_temperature: %s\n&%sT2_temperature: %s\n&%sT3_temperature: %s\n&%sCPU_CP_Master_temperature: %s\n&%sCPU_CP_Slave_temperature: %s\n&%sCPU_AP_temperature: %s\n&%sDisk status: %s\n&%sDisk name: %s\n&%sBox authenticated: %s\n\n" % (uptime_color, uptime, bandwidth_down_color, bandwidth_down, bandwidth_up_color, bandwidth_up, download, upload, fan0_status_color, fan0_rpm, fan1_status_color, fan1_rpm, temp_t1_color, temp_t1, temp_t2_color, temp_t2, temp_t3_color, temp_t3, temp_cpu_cp_master_color, temp_cpu_cp_master, temp_cpu_cp_slave_color, temp_cpu_cp_slave, temp_cpu_ap_color, temp_cpu_ap, disk_status_color, disk_status, disk_name_color, disk_name, box_authenticated_color, box_authenticated)
